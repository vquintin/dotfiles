...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "l", function () awful.spawn("xscreensaver-command -activate") end,
...
client.connect_signal("focus", function(c) c.border_color = "#ff0000"; c.border_width = 2 end)
